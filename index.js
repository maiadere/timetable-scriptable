let scriptName = "timetable";
let scriptUrl = "https://raw.githubusercontent.com/akuvfx/timetable-scriptable/main/main.js";

let modulePath = await downloadModule(scriptName, scriptUrl);
if (modulePath != null) {
